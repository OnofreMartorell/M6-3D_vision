...
%
% Reported performance should be close to  89.4% for the training set 
% (first 25 images) and 89.7% for the test set
...
params.REFINE_THRESHOLD = 0.375;
params.VARIATION_THRESHOLD = .305;
params.DUPLICATES_THRESHOLD = .0039;
