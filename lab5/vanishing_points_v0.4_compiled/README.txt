...
This codes implements the vanishing point detection algorithm as described in
 "Finding Vanishing Points via Point Alignments in Image Primal and Dual
 Domains" Jose Lezama, Rafael Grompone von Gioi, Gregory Randall and Jean-Michel
 Morel. In CVPR 2014.
...
mex_files/	       - folder with auxiliary C sources, to be compiled as mex files
