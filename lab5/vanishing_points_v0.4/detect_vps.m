...
% Copyright (C) 2014 Jose Lezama <jlezama@gmail.com>
%
...
% method parameters
params.REFINE_THRESHOLD = .375; % (theta)
params.VARIATION_THRESHOLD = .15; % (zeta)
params.DUPLICATES_THRESHOLD = .1; % (delta)
params.VERTICAL_ANGLE_THRESHOLD = 75; % (omega)
...
if params.MANHATTAN
    % inclusive threshold
    params.ORTHOGONALITY_THRESHOLD = .058;
else
    % exclusive threshold
    params.ORTHOGONALITY_THRESHOLD = cos(75*pi/180);
end
