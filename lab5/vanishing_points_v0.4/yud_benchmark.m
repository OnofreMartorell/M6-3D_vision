...
%
% Reported performance should be close to  95.61% for the training set 
% (first 25 images) and 95.37% for the test set
...
params.REFINE_THRESHOLD = 1.60;
params.VARIATION_THRESHOLD = .15;
params.DUPLICATES_THRESHOLD = .022;
...
for f = 1:length(Manhattan_Image_DB_Names);
    ...
    manhattan = 1;
    acceleration = 0;
    focal_ratio = 1.05455933619402; % to be multiplied by length of image's largest side
